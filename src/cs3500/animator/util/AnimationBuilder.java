...
/**
 * A helper interface used by our models to make it compatible with animation reader by adding
 * the functionality of our model to this subset of functions.
 * @param <Doc> The type of model this builder is for.
 */
